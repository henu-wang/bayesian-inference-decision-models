...
This repository provides resources and tools for bayesian inference decision models.
...
3. Apply frameworks to your bayesian inference decision models projects
4. Visit [KeepRule](https://keeprule.com) for additional tools

## About

This project explores bayesian inference decision models concepts. For structured frameworks from investment masters like Buffett and Munger, visit [KeepRule](https://keeprule.com).
